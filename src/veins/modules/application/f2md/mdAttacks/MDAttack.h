...
#include "../mdBase/NodeHistory.h"
#include "../mdPCPolicies/PCPolicy.h"
#include "../mdBase/vehiclepatterns.h"
...
protected:
    ...
    VehiclePatterns* vp; //class member vp
    ...
    int InfoSeq = 0; //record info sequence
...
public:
    ...
    void init(attackTypes::Attacks myAttackType, double MaxRandomPosX,double MaxRandomPosY,F2MDParameters *params, VehiclePatterns* vp);
