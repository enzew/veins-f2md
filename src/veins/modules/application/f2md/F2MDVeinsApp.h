...
#include <veins/modules/application/f2md/mdBase/vehiclepatterns.h> //include vehiclepatterns
...
//    bool recording;         // keep recording
    int recordcounter;      //VP record counter
    cMessage* recordLaneChangeEvent; //record timer
=======
...
<<<<<<< HEAD
    virtual void recordLaneChangeInfo(); //record lane change info
    ...
    virtual void initAttack(); //initialization of attack function
...
>>>>>>> 7aacfa11e3e30926eff0d1252549e14694c2ee77
    ...
    VehiclePatterns vp;     //VehiclePatterns member
